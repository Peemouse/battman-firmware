...
CSRC = $(STARTUPSRC) \
       ...
       main.c gpio.c led_rgb.c ltc6803.c comm_usb.c comm_can.c packet.c console.c charger.c analog.c rtcc.c power.c current_monitor.c buzzer.c eeprom.c config.c accessory.c ws2812b.c faults.c fw_updater.c soc.c temp.c flashmem.c
